...
int func4(int x) {
  ...
  int shifted_first16b = (first16b >> 16) & ((1 << 15) + 0xFF); // Clear sign bit
  int sign_bit = first16b & (1 << 15); // Extract the sign bit after shifting
  
  return (last16b << 16) | shifted_first16b | (sign_bit << 1);
